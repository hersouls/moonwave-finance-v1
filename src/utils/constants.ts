...
export const DEFAULT_TRANSACTION_CATEGORIES = {
  income: [
    ...
    { name: '다연여행수입', color: '#14B8A6', icon: 'Plane' },
    { name: '가상화폐수익', color: '#F59E0B', icon: 'Bitcoin' },
    { name: '주식수익', color: '#22C55E', icon: 'LineChart' },
  ...
  expense: [
    ...
    { name: '생활용품', color: '#84CC16', icon: 'Package' },
    { name: '여행', color: '#06B6D4', icon: 'Map' },
    { name: '카드대금', color: '#F43F5E', icon: 'CreditCard' },
    { name: '투자', color: '#6366F1', icon: 'TrendingUp' },
    { name: '패션/미용', color: '#E879F9', icon: 'Shirt' },
    { name: '기타', color: '#71717A', icon: 'MoreHorizontal' },
  ],
} as const
