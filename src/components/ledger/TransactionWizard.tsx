        ...
        <div className="wizard-amount-wrap rounded-xl border-2 border-base transition-all duration-300 focus-within:border-primary-400 dark:focus-within:border-primary-400 focus-within:wizard-amount-glow">
          <div className="relative py-4 px-4">
            <input
              ...
              placeholder="0"
              className="w-full bg-transparent text-center text-3xl sm:text-4xl font-bold tabular-nums text-heading placeholder-[var(--text-disabled)] outline-none"
            />
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                isSelected
                  ? 'border-transparent'
                  : 'bg-surface-secondary border-base hover:border-[var(--border-default)]',
              )}
              style={isSelected ? {
