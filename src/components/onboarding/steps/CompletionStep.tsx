...
export function CompletionStep({ onComplete }: CompletionStepProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full px-6 py-12">
      ...
      <h2 className="text-heading2 text-zinc-900 dark:text-zinc-100 mb-2">설정 완료!</h2>
      <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-2 text-center">FIN을 시작할 준비가 되었습니다.</p>
      <p className="text-caption text-zinc-400 dark:text-zinc-500 mb-10 text-center">대시보드에서 자산을 추가하고 매일 기록해보세요.</p>
