      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 p-4">
          <div className="text-center max-w-md">
            ...
            <h1 className="text-title1 text-zinc-900 dark:text-zinc-100 mb-2">
              오류가 발생했습니다
            </h1>
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-lg text-body3 bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors flex items-center gap-1.5"
              >
